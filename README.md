...
* void freeMemory(int*&)
* void copyArray(int* ,const int, int*) и ещё void copyArray(int* beg, int* end, int* dest)
...
реализация некоторых функций класса дробь https://habr.com/ru/company/skillfactory/blog/535138/         
...
(Пахомович)Класс арифметическая дробь. https://github.com/bsu2019gr9/_WORKFLOW     
...
• Высота - какую пожелаете для удобной генерации градиента     
...
а) (простые - обязательные всем для кодирования) вертикальный-горизонтальный градиент     
б) (сложнее - желательно для кодирования) диагональный градиент     
в) (интересные - для особо желающих) радиальный градиент от центра/угла/произвольной точки, "прямоугольный" градиент от произвольной точки    


## Задание на 30.05 (объекты-значения с массивами)
`(в СВОЙ РЕПОЗИТОРИЙ записать  ПАПКУ с именем 7-1 в которую кидать все свои .h b .cpp)`
